...
QT_MOC_LITERAL(3, 21, 10), // "MyFunction"
QT_MOC_LITERAL(4, 32, 3) // "str"

    },
    "WorkThread\0MySignal\0\0MyFunction\0str"
};
...
void WorkThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->MyFunction((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WorkThread::MySignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void WorkThread::MySignal(QString _t1)
{
